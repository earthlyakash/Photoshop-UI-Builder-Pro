...
class PhotoshopUIBuilder(QMainWindow):
    ...
    def init_ui(self):
        ...
        footer = QLabel("Developed by <b>Akash Kumar</b> | ✉ earthlyakash@gmail.com | License: Free | Version 1.0.0")
    ...
    def setup_canvas(self):
        if self.root_node and not self.prompt_save_if_dirty(): return
        try:
